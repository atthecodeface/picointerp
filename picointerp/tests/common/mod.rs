...
use self::picointerp::{PicoTraceNone};
use self::picointerp::{PicoIRAssembler, PicoIREncoding};
pub fn test_assemble_and_run<P:PicoProgram+PicoIREncoding, V:PicoValue + PartialEq, H:PicoHeap<V>>(source_code:&str, steps:usize, result:isize) {
